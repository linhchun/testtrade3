...
<script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=TJHMnkgGKKjBXyHvoLbbRdoA5M56ioSYYTkVqkcoQcDByH__0A05lU7ecirGOaaSuTRgaLQLI8BBw7VdDJ09HA" charset="UTF-8"></script></head>




<div class="datariumz-wrap">
    <ul>
        <li id="Earning4" data-lbl='' data-val=''></li>
        <li id="Earning3" data-lbl='' data-val=''></li>
        <li id="Earning2" data-lbl='' data-val=''></li>
        <li id="Earning1" data-lbl='' data-val=''></li>
</div>

<div class="datainvest-wrap">
    <ul>
        <li id="Invest4" data-lbl='' data-val=''></li>
        <li id="Invest3" data-lbl='' data-val=''></li>
        <li id="Invest2" data-lbl='' data-val=''></li>
        <li id="Invest1" data-lbl='' data-val=''></li>
</div>

<div class="datawith-wrap">
    <ul>
        <li id="Withdra4" data-lbl='' data-val=''></li>
        <li id="Withdra3" data-lbl='' data-val=''></li>
        <li id="Withdra2" data-lbl='' data-val=''></li>
        <li id="Withdra1" data-lbl='' data-val=''></li>
</div>
...
<body class="dashboard">
    ...
    <div class="language-holder">
      ...
      <svg class="arrow-icon" viewBox="0 0 5.55 10.29">
        <use xlink:href="sprites.svg?v=4#single-arrow"></use>
      </svg>
    </div>
...
<style>
    ...
    <script src="{{asset('js/chartjs-plugin-style.js')}}"></script>
    <script>
        document.write("<script type='text/javascript' src='{{asset('js/dashboard.js')}}'><\/script>");

    </script>
    <script src="{{asset('js/dashboardearn.js')}}"></script>
    <script src="{{asset('js/dashboardinvest.js')}}"></script>
    <script src="{{asset('js/dashboardwith.js')}}"></script>
    <script src="{{asset('js/dashboardGeneral.js')}}"></script>
    <script>
        svg4everybody();
