    ...
    <div class="container">
        <div class="invest-section">
            <div class="payment-balance">
                ...
                <iframe frameborder="0" scrolling="no" height="270px" width="55%"
            ...
            <div class="total-amount">
                ...
                <a class="btn btn--red" style="text-transform: initial" href="#"> + Make
                    a New Investment</a>
            </div>
        </div>
        ...
        <div class="history-profile-status">
            <div class="profile-status" style="width: 100%;">
                ...
                <a style="width: 15%;" class="btn btn--trans" href="#"> Check Profile </a>
            </div>
        </div>
    </div>
...
document.getElementsByClassName('last-access')[0].textContent = today;
</script>
